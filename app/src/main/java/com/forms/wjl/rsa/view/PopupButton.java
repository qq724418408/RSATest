package com.forms.wjl.rsa.view;
...
import com.forms.wjl.rsa.utils.listener.PopupButtonListener;
 ...
 * @author bubbly
 */
public class PopupButton extends android.support.v7.widget.AppCompatCheckBox implements PopupWindow.OnDismissListener {
        ...
        this.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (popupWindow == null) {
                    ...
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, (int) (screenHeight * 0.4));
