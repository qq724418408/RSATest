...
/**
 * Created by bubbly on 2017/12/18.
 */
...
public class TimeUtils {
     ...
     */
    public static TimeUtils timeSpanSecond(long second) {
        ...
        try {
            ...
            if (ts.mSpanSecond > 0) {
                ts.mSpanSecondText = ts.mSpanSecond + "秒";
            }
            if (ts.mSpanDay > 0) {
                ts.mSpanHourText = "";
                ts.mSpanMinuteText = "";
     ...
     */
    public static TimeUtils timeSpanToNow(String time) {
        TimeUtils ts = new TimeUtils();
